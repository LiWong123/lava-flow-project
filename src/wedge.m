...
geometry.addObstacleFromEdge(xEdge, yEdge, 0.2);
geometry.setModel();
...
% 
% applyBoundaryCondition(pde.model,'dirichlet','Edge',[2,3,4,7],'u',1);
% applyBoundaryCondition(pde.model,'neumann','edge',[1,6],'q',@fluxcond2,'g',pde.epsilon);
